                    ...
                    <div class="atbd-form-checkout">
                        <a-row justify="center">
                            <a-col :sm="22" :xs="24">
                                <div class="create-account-form">
                                    <sdHeading as="h4"
                                        >2. Please Fill in Your Shipping
                                        Address</sdHeading
                                    >
                                    <a-form
                        ...
                        <a-row justify="center">
                            <a-col :sm="22" :xs="24">
                                <div class="payment-method-form">
                                    <sdHeading as="h4"
                                        >3. Please Please Select Your Payment
                                        Method</sdHeading
                                    >
                                    <div class="shipping-selection">
                                        ...
                                        >
                                            <div
                                                class="shipping-selection__card"
                                            >
                                                <a-radio
                                                    :style="{ width: '100%' }"
                                                    value="card"
                                            ...
                                            <div
                                                class="shipping-selection__paypal"
                                            >
                                                <a-radio
                                                    value="payPal"
                                                    :style="{ width: '100%' }"
                                                >
                                                    ...
                                                    <img
                                                        :src="
                                                            require('@/static/img/PayPalLogo.png')
                                                        "
                                                        alt="paypal"
                                                    />
                                                </a-radio>
                                            ...
                                            <div
                                                class="shipping-selection__cash"
                                            >
                                                <a-radio
                                                    value="cash"
                                                    :style="{ width: '100%' }"
            ...
            <template #review>
                ...
                >
                    <div class="atbd-review-order" :style="{ width: '100%' }">
                        <sdHeading as="h4"
                            >4. Review and confirm Order</sdHeading
                        >
                        <sdCards
                            :bodyStyle="{
                        ...
                        >
                            <div class="atbd-review-order__single">
                                <sdCards headless>
                                    <div
                                        class="atbd-review-order__shippingTitle"
                                    >
                                        <sdHeading as="h5">
                                    ...
                                    <article
                                        class="atbd-review-order__shippingInfo"
                                    >
                                        <a-radio-group
                                            :style="{ width: '100%' }"
                                        >
                                ...
                                <sdCards headless>
                                    ...
                                    <a-row justify="end">
                                        ...
                                        >
                                            <OrderSummary>
                                                <div
                                                    class="invoice-summary-inner"
                                                >
                                                    <ul class="summary-list">
                                                        <li>
                                                            <span
                                                                class="summary-list-title"
                                                                >Subtotal
                                                                :</span
                                                            >
                                                            <span
                                                    ...
                                                    >
                                                        <span
                                                            class="summary-total-label"
                                                            >Total :
                                                        </span>
                                                        <span
                                                            class="summary-total-amount"
                                                            >{{
                                                                `$${
                                                                    subtotal +
                                                                    30 -
...
const CheckOut = {
    ...
    setup(_, { emit }) {
        ...
        const decrementUpdate = (id, quantity) => {
            const data =
                parseInt(quantity, 10) >= 2 ? parseInt(quantity, 10) - 1 : 1;
            dispatch('cartUpdateQuantity', {
                id,
                quantity: data,
                cartData: cartData.value,
        ...
        const cartDeleted = (id) => {
            ...
            if (confirm)
                dispatch('cartDelete', { id, cartData: cartData.value });
        };
        ...
        const dataSource = computed(() => {
            ...
            return state.cart.data.map((data) => {
                ...
                return {
                    ...
                    total: (
                        <span class='cart-single-t-price'>
                            ${quantity * price}
                        </span>
                    ),
                    action: (
