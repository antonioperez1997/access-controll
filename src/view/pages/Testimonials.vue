                                ...
                                <Swiper v-bind="paramsTwo" navigation>
                                    ...
                                    >
                                        <span class="quotation">
                                            <img
                                                :src="
                                                    require(`../../static/img/icon/quote.png`)
                                                "
                                                alt=""
                                            />
                                        </span>
                                        ...
                                        <div class="testimonial-block__review">
                                            <p>
                                                ...
                                                that a reader will page when
                                                looking at its was layout. The
                                                point of be distracted by the
                                                readable will page when looking
                                                at its was layout will page when
                                                looking.
                                            </p>
                                        </div>
                                    </SwiperSlide>
                            ...
                            <div class="testimonial-block theme-3">
                                ...
                                <div class="testimonial-wrapper">
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                class="testimonial-block__inner"
                                            >
                                                <div
                                                    class="testimonial-block__review"
                                                >
                                                    <p>
                                                        It is a long established
                                                        fact that a reader will
                                                        page when looking at its
                                                        was layout. The point of
                                                        be distracted by the
                                                        readable will page when
                                                        looking at its was
                                                        layout will page when
                                                        looking.
                                                    </p>
                                                </div>
                                                <div
                                                    class="testimonial-block__author"
                                                >
                                                    <div class="author-info">
                                    ...
                                    >
                                        <div class="testimonial-block__inner">
                                            ...
                                            >
                                                <p>
                                                    It is a long established
                                                    fact that a reader will page
                                                    when looking at its was
                                                    layout. The point of be
                                                    distracted by the readable
                                                    will page when looking at
                                                    its was layout will page
                                                    when looking.
                                                </p>
                                            </div>
                                            <div class="author-info">
...
export default defineComponent({
    ...
    setup() {
        ...
        const users = store.state.users.data;
        const paramsOne = {
            slidesPerView: 3,
            spaceBetween: 30,
            centeredSlides: true,
